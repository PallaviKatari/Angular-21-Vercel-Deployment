...
export class DataBinding {
  ...
  constructor(private messageService: Message) {
    ...
    console.log(messageService.promiseFunction());
    console.log("Observable Function: ");
    console.log(messageService.observableFunction);
  }
  ...
  onKeydown(event: KeyboardEvent) {
    this.keyPressed = `Key pressed: ${event.key}`;
  }
  ...
  onChange(event: Event) {
    ...
    this.changedValue = `Changed value: ${input.value}`;
  }

  // Two-way Binding
  twoWayValue: string = 'John Doe';
}
